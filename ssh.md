...
| 用語 | 目的 | 生成者 | 補足 |
|------|------|--------|--------|
| 鍵交換用のクライアントの秘密鍵/公開鍵 | クライアントとサーバの安全な通信路を確立 | クライアント | シーケンス図上では「交C秘」「交C公」と表現 |
| 鍵交換用のサーバの秘密鍵/公開鍵 | クライアントとサーバの安全な通信路を確立 | サーバ | シーケンス図上では「交S秘」「交S公」と表現 |
| ホスト認証用の秘密鍵/公開鍵 | サーバ認証用 | サーバ | シーケンス図上では「認秘」「認公」と表現 |
